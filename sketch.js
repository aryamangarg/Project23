...
function setup() {
  ...
  basket=createSprite(400,680,100,20)
  World.add(world, basket)
  basket2=createSprite(390,680,20,100)
  World.add(world,basket2)
  basket3=createSprite(410,680,20,100)
...
Matter.Body.setStatic(basket,true);
Matter.Body.setStatic(basket2,true);
Matter.Body.setStatic(basket3,true);
  drawSprites();
}
function keyPressed() {
